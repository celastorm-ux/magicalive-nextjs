            ...
            <div className="mt-4 flex items-start gap-4">
              ...
              <div className="min-w-0 flex-1">
                ...
                {event.magician_id ? (
                  <Link
                    href={`/profile/magician?id=${encodeURIComponent(event.magician_id)}`}
                    className="mt-4 inline-flex text-sm text-[var(--ml-gold)]/80 transition hover:underline"
                  >
                    View full profile →
                  </Link>
                ) : null}
                ...
                moreByMagician.map((s) => (
                  <li key={s.id}>
                    <Link
                      ...
                      className="block rounded-lg border border-white/10 bg-black/30 px-3 py-2 transition hover:border-[var(--ml-gold)]/30"
                    >
        ...
        <div className="rounded-2xl border border-white/10 bg-white/[0.03] p-6">
          <div className="flex items-center justify-between gap-4">
            ...
            {event.magician_id ? (
              <Link
                href={`/profile/magician?id=${encodeURIComponent(event.magician_id)}`}
                className="text-sm text-[var(--ml-gold)]/80 transition hover:underline"
              >
                See all
              </Link>
            ) : null}
