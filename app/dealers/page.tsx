...
export const metadata: Metadata = {
  title: "Dealers — PinnacleMagic",
  description: "Discover magic dealers and suppliers around the world.",
};
    ...
    <div className="min-h-0 flex-1 bg-black pb-20 pt-8 text-zinc-100 sm:pt-12">
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-12">
        ...
        <h1 className="ml-font-heading text-4xl font-semibold tracking-tight text-zinc-50 sm:text-5xl">
          Magic <span className="italic text-[var(--ml-gold)]">dealers</span>
        </h1>
        <p className="mt-4 max-w-xl text-sm text-zinc-400 sm:text-base">
          We&apos;re building a directory of magic dealers and suppliers. Check back soon.
        </p>
        <Link
          href="/"
