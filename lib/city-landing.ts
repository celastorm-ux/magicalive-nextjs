...
export const CITY_LANDING_PAGES: CityLandingDefinition[] = [
  {
    ...
    seoParagraphs: [
      ...
      "The city’s mix of studios, hotels, and casinos means performers frequently work intimate salons, rooftop soirées, and full-scale theaters in the same month. PinnacleMagic helps you compare reels, reviews, and upcoming appearances before you reach out for a hold date.",
    ...
    hireBookerParagraphs: [
      ...
      "Whether you need a corporate magician for a product launch in Downtown LA, walk-around for a Westside gala, or a specialist for a Malibu wedding, PinnacleMagic lists verified professionals you can reach with a booking request.",
    ],
  ...
  },
  {
    ...
    seoParagraphs: [
      "New York audiences are sharp: corporate clients in Midtown, theater crowds off Broadway, and private clients in loft spaces all expect tight routining and impeccable timing. PinnacleMagic lists professionals who regularly work the city’s high expectations.",
    ...
    hireBookerParagraphs: [
      ...
      "When you hire a magician in New York, venue logistics and tight schedules matter as much as the tricks. PinnacleMagic helps you shortlist talent with real reviews, clear specialties, and a direct path to request a quote for your date.",
    ],
  ...
  },
  {
    ...
    seoParagraphs: [
      "Chicago’s magic footprint spans corporate Lake Shore events, neighborhood theaters, and festival stages across the metro. PinnacleMagic highlights performers who travel the region and anchor residencies downtown.",
      ...
      "Use PinnacleMagic to preview upcoming public dates, compare social proof, and message talent directly — without losing weeks to back-and-forth logistics.",
    ],
    hireBookerParagraphs: [
      ...
      "Planning a gala, conference after-party, or private celebration? Hire a magician in Chicago through PinnacleMagic to compare profiles, check who works your side of the metro, and send a single booking request with your event details.",
    ],
  ...
  },
  {
    ...
    seoParagraphs: [
      ...
      "PinnacleMagic profiles show who is actively performing in Southern Nevada, what formats they offer, and how buyers rate past bookings — critical when you need a shortlist fast.",
    ...
    hireBookerParagraphs: [
      ...
      "To hire a magician in Las Vegas for a corporate event, wedding weekend, or private party, use PinnacleMagic to see who is active in Southern Nevada, read verified feedback, and request availability without guessing who takes outside bookings.",
    ],
  ...
  },
  {
    ...
    seoParagraphs: [
      ...
      "PinnacleMagic connects event teams with artists experienced in Microsoft-campus adjacent meetings, Capitol Hill celebrations, and Eastside corporate retreats alike.",
    ...
    hireBookerParagraphs: [
      ...
      "Hire a magician in Seattle through PinnacleMagic to find performers accustomed to Pacific Northwest venues, timelines, and the mix of intimate gatherings and larger corporate programs that define the region.",
    ],
  ...
  },
  {
    ...
    seoParagraphs: [
      ...
      "PinnacleMagic helps talent buyers shortlist magicians who already route through Tennessee and understand load-ins on Broadway-adjacent venues as well as Franklin estates.",
    ...
    hireBookerParagraphs: [
      ...
      "Whether you are planning a corporate night, album-release party, or private estate event, hire a magician in Nashville on PinnacleMagic to browse profiles, compare styles, and reach out with a structured booking request.",
    ],
  ...
  },
  {
    ...
    seoParagraphs: [
      ...
      "On PinnacleMagic you’ll find performers who routinely work hillside homes, boutique hotels, and private clubs from Beachwood to the Boulevard.",
    ...
    hireBookerParagraphs: [
      ...
      "Booking a magician in Hollywood means matching the energy of legacy magic rooms and modern hospitality spaces alike. PinnacleMagic connects planners with verified talent for intimate lounges or full-scale private events.",
    ],
